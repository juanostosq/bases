 ...
 * @author FAMILIA
 */
public class DeleteReservacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ResultSet res=db.cargar_Funcion(request.getParameter("numHab"));
            h.setNumero_sala(request.getParameter("numSal"));
            rese.cancelar_reservacion(u, h);
            out.println("<br><br><br><div align=\"center\">");
            out.println("<td><h3>La Cancelacion ha sido exitosa</h3></td>");
